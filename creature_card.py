...
archwing_dragon = CreatureCard(
    ...
    abilities=["Flying, haste "
               "\nAt the beggining of the end step, return Archwing Dragon to its owner's hand."],
)
balefire_dragon = CreatureCard(
    ...
    toughness=6,
    abilities=["Flying"
               "\nWhenever Balefire Dragon daels combat damage to a player, it deals that much damage to each creature that player controls. "],
)
...
dragon_whelp = CreatureCard(
    ...
    toughness=3,
    abilities=["Flying"
               "\nChaosX1: +1/0; if more than three mana was spent this way, Dragon Whelp is destroyed at the end of turn."],
)
...
karametras_acolyte = CreatureCard(
    ...
    power=1,
    toughness=4,
    abilities=["Tap: Add an amount of Forest to your mana pool equal to your devotion to green."],
)
...
storm_herald = CreatureCard(
    ...
    toughness=2,
    abilities=["Haste"
               "\nWhen Storm Herald enters the battlefield, return any number of Aura cards from your graveyard to the battlefield attached to creatures you control. Exile all those Auras at the begining of your next end step. If those Auras would leave the"
                " battlefield exile them instead of putting them anywhere else. "],
)
...
utvara_hellkite = CreatureCard(
    ...
    toughness=6,
    abilities=[ "Flying" 
               "\nWhenever a Dragon you control attacks, put a 6/6 red Dragon creature token with flying into the battlefield. "],
)
utvara_corgi = CreatureCard(
    ...
    abilities=[ "Deathtouch, infect"
               "\nWhenever another creature attacks, put a 1/1 Green wolf creature token with infect into the battlefield. "],
)
